...
def efeito_casa(jogador):
    ...
    if cor_casa == cores["branco"]:
        ...
        pygame.mixer.Sound("som_azul.wav").play() #som parecido com o de pegar uma moeda num jogo comum
...
while True:
    ...
    for evento in pygame.event.get():
        ...
        if evento.type == KEYDOWN:
            ...
            #confirmar ordem só quando apertar TAB, para os jogadores terem tempo de ver o resultado do dado
